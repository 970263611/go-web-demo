...
func (dc *DeptCreate) SetDeptId(s string) *DeptCreate {
	dc.mutation.SetDeptId(s)
	return dc
}
...
func (dc *DeptCreate) SetParentId(s string) *DeptCreate {
	dc.mutation.SetParentId(s)
	return dc
}

// SetNillableParentId sets the "parentId" field if the given value is not nil.
func (dc *DeptCreate) SetNillableParentId(s *string) *DeptCreate {
	if s != nil {
		dc.SetParentId(*s)
	}
	return dc
...
func (dc *DeptCreate) SetExt(s string) *DeptCreate {
	dc.mutation.SetExt(s)
	return dc
}

// SetNillableExt sets the "ext" field if the given value is not nil.
func (dc *DeptCreate) SetNillableExt(s *string) *DeptCreate {
	if s != nil {
		dc.SetExt(*s)
	}
	return dc
...
func (dc *DeptCreate) check() error {
	if _, ok := dc.mutation.DeptId(); !ok {
		return &ValidationError{Name: "deptId", err: errors.New(`ent: missing required field "Dept.deptId"`)}
	}
	if v, ok := dc.mutation.DeptId(); ok {
...
func (dc *DeptCreate) createSpec() (*Dept, *sqlgraph.CreateSpec) {
	...
	if value, ok := dc.mutation.DeptId(); ok {
	...
	if value, ok := dc.mutation.Ext(); ok {
