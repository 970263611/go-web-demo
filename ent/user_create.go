...
func (uc *UserCreate) SetDefaultPassword(s string) *UserCreate {
	uc.mutation.SetDefaultPassword(s)
	return uc
}

// SetIsAdmin sets the "isAdmin" field.
func (uc *UserCreate) SetIsAdmin(ua user.IsAdmin) *UserCreate {
	uc.mutation.SetIsAdmin(ua)
	return uc
}

// SetNillableIsAdmin sets the "isAdmin" field if the given value is not nil.
func (uc *UserCreate) SetNillableIsAdmin(ua *user.IsAdmin) *UserCreate {
	if ua != nil {
		uc.SetIsAdmin(*ua)
	}
	return uc
...
func (uc *UserCreate) SetLoginTime(i int64) *UserCreate {
	uc.mutation.SetLoginTime(i)
	return uc
}

// SetNillableLoginTime sets the "loginTime" field if the given value is not nil.
func (uc *UserCreate) SetNillableLoginTime(i *int64) *UserCreate {
	if i != nil {
		uc.SetLoginTime(*i)
	}
	return uc
...
func (uc *UserCreate) SetAuthList(m map[string]interface{}) *UserCreate {
	uc.mutation.SetAuthList(m)
	return uc
}
...
func (uc *UserCreate) check() error {
	...
	if v, ok := uc.mutation.UserCode(); ok {
	...
	if _, ok := uc.mutation.DefaultPassword(); !ok {
		return &ValidationError{Name: "defaultPassword", err: errors.New(`ent: missing required field "User.defaultPassword"`)}
	}
	if v, ok := uc.mutation.DefaultPassword(); ok {
	...
	if v, ok := uc.mutation.IsAdmin(); ok {
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.DefaultPassword(); ok {
	...
	if value, ok := uc.mutation.AuthList(); ok {
		_spec.SetField(user.FieldAuthList, field.TypeJSON, value)
		_node.AuthList = value
	}
	return _node, _spec
}
